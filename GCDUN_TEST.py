...
def main():
    ...
    model = GCDUN(sensing_rate=args.sensing_rate, LayerNo=args.layer_num)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='GCDUN', help='model name')
    parser.add_argument('--sensing-rate', type=float, default=0.3, help='set sensing rate')
    ...
    parser.add_argument('--result_dir', type=str, default='./result/GCDUN', help='result directory')
    main()
