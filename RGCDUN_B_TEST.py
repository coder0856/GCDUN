...
def main():
    ...
    model = RGCDUN(sensing_rate=args.sensing_rate, LayerNo=args.layer_num)
    ...
    result_dir = os.path.join(result_dir, ('%.2f' % args.sensing_rate))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='RGCDUN_binary', help='model name')
    parser.add_argument('--sensing-rate', type=float, default=0.10, help='set sensing rate')
    ...
    parser.add_argument('--layer_num', type=int, default=8, help='phase number of the Net')
    parser.add_argument('--test_name', type=str, default='Set11', help='name of test set')
    parser.add_argument('--result_dir', type=str, default='./result/RGCDUN', help='result directory')
    main()
